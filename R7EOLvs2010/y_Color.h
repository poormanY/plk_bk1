...
#define GREY_ROAD_NIGHT			RGB(40, 40, 40)
...
#define GREY100_WHITE			RGB(255, 255, 255)
#define DARK_SLATE_GREY			RGB(47, 79, 79)
#define DIM_GREY				RGB(84, 84, 84)
#define VERY_LIGHT_GREY			RGB(205, 205, 205)
#define FREE_SPEECH_GREY		RGB(99, 86, 136)
#define ALICEBLUE				RGB(240, 248, 255)
#define BLUEVIOLET				RGB(138, 43, 226)
#define CADET_BLUE				RGB(95, 159, 159)
...
#define CORN_FLOWER_BLUE		RGB(66, 66, 111)
...
#define ROYALBLUE5				RGB(0, 34, 102)
...
#define AQUAMARINE3_MEDIUMAQUAMARINE		RGB(102, 205, 170)
...
#define TRUE_IRIS_BLUE			RGB(3, 180, 204)
...
#define DARK_SLATE_BLUE			RGB(36, 24, 130)
#define DARK_TURQUOISE			RGB(112, 147, 219)
#define MEDIUM_SLATE_BLUE		RGB(127, 0, 255)
#define MEDIUM_TURQUOISE		RGB(112, 219, 219)
#define MIDNIGHT_BLUE			RGB(47, 47, 79)
#define NAVY_BLUE				RGB(35, 35, 142)
#define NEON_BLUE				RGB(77, 77, 255)
#define NEW_MIDNIGHT_BLUE		RGB(0, 0, 156)
#define RICH_BLUE				RGB(89, 89, 171)
#define SKY_BLUE				RGB(50, 153, 204)
#define SLATE_BLUE				RGB(0, 127, 255)
#define SUMMER_SKY				RGB(56, 176, 222)
#define IRIS_BLUE				RGB(3, 180, 200)
#define FREE_SPEECH_BLUE		RGB(65, 86, 197)
...
#define DARK_BROWN				RGB(92, 64, 51)
...
#define BAKERS_CHOCOLATE		RGB(92, 51, 23)
...
#define DARK_TAN				RGB(151, 105, 79)
#define DARK_WOOD				RGB(133, 94, 66)
#define LIGHT_WOOD				RGB(133, 99, 99)
#define MEDIUM_WOOD				RGB(166, 128, 100)
#define NEW_TAN					RGB(235, 199, 158)
#define SEMI_SWEET_CHOCOLATE	RGB(107, 66, 38)
//#define SIENNA				RGB(142, 107, 35)
//#define TAN					RGB(219, 147, 112)
#define VERY_DARK_BROWN			RGB(92, 64, 51)
#define DARK_GREEN				RGB(47, 79, 47)
#define DARKGREEN				RGB(0, 100, 0)
#define DARK_GREEN_COPPER		RGB(74, 118, 110)
...
#define SEAGREEN_SEAGREEN4		RGB(46, 139, 87)
...
#define DARK_OLIVE_GREEN		RGB(79, 79, 47)
#define GREEN_YELLOW			RGB(209, 146, 117)
#define HUNTER_GREEN			RGB(142, 35, 35)
#define FOREST_GREEN_KHAKI_MEDIUM_AQUAMARINE	RGB(35, 142, 35)
#define MEDIUM_FOREST_GREEN		RGB(219, 219, 112)
#define MEDIUM_SEA_GREEN		RGB(66, 111, 66)
#define MEDIUM_SPRING_GREEN		RGB(127, 255, 0)
#define PALE_GREEN				RGB(143, 188, 143)
#define SEA_GREEN				RGB(35, 142, 104)
#define SPRING_GREEN			RGB(0, 255, 127)
#define FREE_SPEECH_GREEN		RGB(9, 249, 17)
#define FREE_SPEECH_AQUAMARINE	RGB(2, 157, 116)
...
#define MANDARIAN_ORANGE		RGB(142, 35, 35)
//#define ORANGE				RGB(255, 127, 0)
#define ORANGE_RED				RGB(255, 36, 0)
...
#define FLESH					RGB(245, 204, 176)
#define FELDSPAR				RGB(209, 146, 117)
...
#define DUSTY_ROSE				RGB(133, 99, 99)
//#define FIREBRICK				RGB(142, 35, 35)
#define INDIAN_RED				RGB(245, 204, 176)
//#define PINK					RGB(188, 143, 143)
//#define SALMON				RGB(111, 66, 66)
#define SCARLET					RGB(140, 23, 23)
#define SPICY_PINK				RGB(255, 28, 174)
#define FREE_SPEECH_MAGENTA		RGB(227, 91, 216)
#define FREE_SPEECH_RED			RGB(192, 0, 0)
...
#define MEDIUM_ORCHID			RGB(147, 112, 219)
#define MEDIUMPURPLE1			RGB(171, 130, 255)
#define DARK_ORCHID				RGB(153, 50, 205)
...
#define VIOLET_BLUE				RGB(159, 95, 159)
#define DARK_PURPLE				RGB(135, 31, 120)
//#define MAROON				RGB(128, 0, 0)
#define MEDIUM_VIOLET_RED		RGB(219, 112, 147)
#define NEON_PINK				RGB(255, 110, 199)
//#define PLUM					RGB(234, 173, 234)
#define THISTLE					RGB(216, 191, 216)
//#define TURQUOISE				RGB(173, 234, 234)
#define VIOLET					RGB(79, 47, 79)
#define VIOLET_RED				RGB(204, 50, 153)
...
#define MEDIUM_GOLDENROD		RGB(234, 234, 174)
#define YELLOW_GREEN			RGB(153, 204, 50)
#define COPPER					RGB(184, 115, 51)
#define COOL_COPPER				RGB(217, 135, 25)
#define GREEN_COPPER			RGB(133, 99, 99)
#define BRASS					RGB(181, 166, 66)
#define BRONZE					RGB(140, 120, 83)
#define BRONZE_II				RGB(166, 125, 61)
#define BRIGHT_GOLD				RGB(217, 217, 25)
#define OLD_GOLD				RGB(207, 181, 59)
#define CSS_GOLD				RGB(204, 153, 0)
//#define GOLD					RGB(205, 127, 50)
#define SILVER					RGB(230, 232, 250)
#define SILVER_GREY				RGB(192, 192, 192)
#define LIGHT_STEEL_BLUE		RGB(84, 84, 84)
#define STEEL_BLUE				RGB(35, 107, 142)
